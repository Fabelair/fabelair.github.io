...
function App() {
  ...
  return (
    <Router>
        <Routes>
            <Route path="/" element={
              <div class="select-none h-[98vh] grid lg:grid-rows-10 grid-rows-22">
                <div class="place-self-center row-start-2 lg:row-start-1 lg:mt-5"><h1 class="text-7xl lg:text-4xl">TheMillionSeconds.com</h1></div>
